    ...
    <div className="agro-container" style={{ padding: '25px 25px 0 25px' }}>
      <div className="agro-unified-card" style={{ 
        ...
        <div className="agro-header-compact" style={{ 
          ...
          <div>
            <h2 style={{ fontSize: '18px', marginBottom: '1px' }}>Supplier Profile</h2>
            <p style={{ fontSize: '12px', margin: 0 }}>Business and contact specifications for this vendor</p>
          </div>
          <button className="btn-agro btn-outline" onClick={() => navigate('/suppliers')} style={{ height: '34px', padding: '0 12px', fontSize: '12px' }}>
            <X size={16} /> Back
          </button>
        </div>
          ...
          <div style={{ 
            ...
            <div style={{ marginTop: '30px', width: '100%', display: 'flex', flexDirection: 'column', gap: '15px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  <div style={{ fontSize: '9px', color: 'var(--text-muted)', fontWeight: '700', textTransform: 'uppercase' }}>Alt Mobile</div>
                  <div style={{ fontSize: '13px', color: 'var(--text-dark)', fontWeight: '600' }}>{formData.altMobileNo || 'N/A'}</div>
                </div>
              </div>
            </div>
          </div>
