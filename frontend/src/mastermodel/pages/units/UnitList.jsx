...
const UnitList = () => {
  ...
  const handleAdd = () => navigate('/units/create');
  const handleEdit = (item) => navigate(`/units/edit/${item.id}`);
      ...
      <div className="agro-unified-card">
        <div className="agro-header-compact" style={{
          ...
          <div style={{ flexShrink: 0 }}>
            <h2 style={{ marginBottom: '2px', fontSize: '20px' }}>Units of Measurement</h2>
            <p style={{ margin: 0, fontSize: '13px' }}>Manage product units (kg, ltr, etc.)</p>
          </div>
